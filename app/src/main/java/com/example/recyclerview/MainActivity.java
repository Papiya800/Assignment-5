...
public class MainActivity extends AppCompatActivity {
    ...
    ArrayList courseName = new ArrayList<>(Arrays.asList("Orange", "Apple","Mango", "Banana", "Pineapple",
            "Watermelon", "Papaya", "Amla", "Avocado", "Kiwi", "Lemon", "Star Fruit", "Dragon Fruit", "Guava" ));
